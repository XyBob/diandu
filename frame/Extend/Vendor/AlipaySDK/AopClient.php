...
class AopClient {
	...
	//私钥值
	public $rsaPrivateKey='';
	...
	public function alonersaSign($data,$privatekey,$signType = "RSA",$keyfromfile=false) {
		...
		log_file('res:'.$res,'Alipay');
		($res) or die('您使用的私钥格式错误，请检查RSA私钥配置'); 
		log_file('Data:'.json_encode($data),'Alipay');
		if ("RSA2" == $signType) {
			$ret = openssl_sign($data, $sign, $res, OPENSSL_ALGO_SHA256);
			log_file('Sign:'.$sign,'Alipay');
			log_file('Result:'.json_encode($ret).'OPENSSL_ALGO_SHA256:'.OPENSSL_ALGO_SHA256,'Alipay');
			log_file('Error:'.openssl_error_string(),'Alipay');
		} else {
			openssl_sign($data, $sign, $res);
		}
