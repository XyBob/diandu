...
class Common_util_pub
{
	 ...
	 * 	作用：生成签名
	 */
	public function getAppSign($Obj)
	{
...
class Wxpay_client_pub extends Common_util_pub 
{
	...
	function setParameter($parameter, $parameterValue)
	{
		...
		//log_file('test = ' .$this->parameters[$this->trimString($parameter)]  , 'wxpay');
	}
	...
	function createAppXml()
	{
		...
		$this->parameters["mch_id"] = $wxpay_obj->MCHID;//商户号
		$this->parameters["nonce_str"] = $this->createNoncestr();//随机字符串
		$this->parameters["sign"] = $this->getAppSign($this->parameters);//签名
		return  $this->arrayToXml($this->parameters);
	}
...
class JsApi_pub extends Common_util_pub
{
	...
	public function getAPPParameters()
	{
		...
		$arr['paySign'] = $this->getAppSign($arr);
		#dump($arr);
