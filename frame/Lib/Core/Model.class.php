...
class Model {
    ...
    public function add($data='',$options=array(),$replace=false) {
        ...
        if(false !== $result ) {
            ...
            if($insertId) {
				...
				//写操作日志，封装方法到functions.php
				$tableName = $this->trueTableName ? $this->trueTableName : $this->tableName;
				add_log($insertId, 1, $tableName, $this->getLastSql());
    ...
    public function save($data='',$options=array()) {
        ...
        if(false !== $result) {
			...
			//写操作日志，封装方法到functions.php
			$tableName = $this->trueTableName ? $this->trueTableName : $this->tableName;
			$id_name = cc_format($tableName) . '_id';
			add_log($this->id_name, 2, $tableName, $this->getLastSql());
        }
        return $result;
    }
    // 更新数据前的回调方法
