...
//		$.jPops.showLoading();
		$.post('/McpItemPackage/get_items_ajax',{'title':item_name,'category':category_id,'brand':brand_id,'mall_price':mall_price},function(data){
//			$.jPops.hideLoading();
...
//	        	del_insert();
	...
	$.post('/McpItemPackage/get_items_ajax',{},function(data){
		insert_new_item_inf(data);
	});
	main_function();
	onloadFunction();
