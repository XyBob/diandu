...
//		console.log(item_arr);
	...
	$('.search').click(function(){
		var page_name = $('#jpops-container').find('#page_name').val();
		var file_name = $('#jpops-container').find('#file_name').val();
		
		console.log({'title':page_name,'file_name':file_name});
//		$.jPops.showLoading();
		$.post('/McpTempletPackage/get_items_ajax',{'page_name':page_name,'file_name':file_name},function(data){
//			$.jPops.hideLoading();
...
//	        	del_insert();
	...
	$.post('/McpTempletPackage/get_items_ajax',{},function(data){
        console.log(data);
		insert_new_item_inf(data);
	});
	main_function();
...
//	console.log(i);
    ...
    var page_url = $("#page_url_ajax").val();
