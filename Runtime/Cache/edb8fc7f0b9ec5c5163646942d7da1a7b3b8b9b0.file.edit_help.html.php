<?php /* Smarty version Smarty-3.1.6, created on 2017-07-24 13:38:16
         compiled from "C:\wamp\www\diandu\Tpl\AcpHelp\edit_help.html" */ ?>
<?php /*%%SmartyHeaderCode:6639597587c830a116-33601776%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'edb8fc7f0b9ec5c5163646942d7da1a7b3b8b9b0' => 
    array (
      0 => 'C:\\wamp\\www\\diandu\\Tpl\\AcpHelp\\edit_help.html',
      1 => 1492838050,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '6639597587c830a116-33601776',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_597587c88608a',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_597587c88608a')) {function content_597587c88608a($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_truncate')) include 'C:\\wamp\\www\\diandu\\frame\\Extend\\Vendor\\Smarty\\plugins\\modifier.truncate.php';
...
<div class="formitems inline">  
    ...
    <div class="form-controls">  
        <input type="text" placeholder="" class="xlarge" name="title" id="title" value="<?php echo $_smarty_tpl->tpl_vars['help_data']->value['title'];?>
">  
...
<div class="formitems inline">
    ...
    <div class="form-controls">
        <select name="sort_id" id="sort_id">
            ...
            <?php echo smarty_function_html_options(array('options'=>$_smarty_tpl->tpl_vars['help_center_category_options']->value,'selected'=>$_smarty_tpl->tpl_vars['help_data']->value['help_sort_id']),$_smarty_tpl);?>
...
<div class="formitems inline">  
    ...
    <div class="form-controls">  
        <input type="text" placeholder="" class="mini" style=" width:45px;" name="serial" id="serial" value="<?php echo $_smarty_tpl->tpl_vars['help_data']->value['serial'];?>
"> 
    </div>  
</div>
<div class="formitems inline">  
    ...
    <div class="form-controls">  
        <div class="radio-group">  
            <label><input type="radio" name="isuse" value="1" <?php if ($_smarty_tpl->tpl_vars['help_data']->value['isuse']==1){?>checked="checked"<?php }?>>是</label>  
            <label><input type="radio" name="isuse" value="0" <?php if ($_smarty_tpl->tpl_vars['help_data']->value['isuse']==0){?>checked="checked"<?php }?>>否</label>   
        </div>  
    </div>  
</div> 
<!-- <div class="formitems inline">  
    ...
    <div class="form-controls">  
        <div class="radio-group">  
            <label><input type="radio" name="is_navigator_show" value="1" <?php if ($_smarty_tpl->tpl_vars['help_data']->value['is_navigator_show']==1){?>checked="checked"<?php }?>>是</label>  
            <label><input type="radio" name="is_navigator_show" value="0" <?php if ($_smarty_tpl->tpl_vars['help_data']->value['is_navigator_show']==0){?>checked="checked"<?php }?>>否</label>   
        </div>  
    </div>  
</div> 
<div class="formitems inline">  
    ...
    <div class="form-controls">  
        <div class="radio-group">  
            <label><input type="radio" name="is_bottom_show" value="1" <?php if ($_smarty_tpl->tpl_vars['help_data']->value['is_bottom_show']==1){?>checked="checked"<?php }?>>是</label>  
            <label><input type="radio" name="is_bottom_show" value="0" <?php if ($_smarty_tpl->tpl_vars['help_data']->value['is_bottom_show']==0){?>checked="checked"<?php }?>>否</label>   
        </div>  
    </div>  
</div>  -->
<div class="formitems inline">  
    ...
    <div class="form-controls" id="ke">  
        <textarea name="contents" id="contents" class="large"><?php echo $_smarty_tpl->tpl_vars['help_data']->value['contents'];?>
</textarea>
    </div>  
</div> 
<div class="formitems inline">  
