<?php /* Smarty version Smarty-3.1.6, created on 2017-08-01 15:10:23
         compiled from "C:\wamp\www\diandu\Tpl\AcpConfig\set_range.html" */ ?>
<?php /*%%SmartyHeaderCode:319945980295fdac176-88201489%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '7ad2844f55c7e03c23f3d0f5c429172990667dab' => 
    array (
      0 => 'C:\\wamp\\www\\diandu\\Tpl\\AcpConfig\\set_range.html',
      1 => 1495845316,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '319945980295fdac176-88201489',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_598029603d5f0',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_598029603d5f0')) {function content_598029603d5f0($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_truncate')) include 'C:\\wamp\\www\\diandu\\frame\\Extend\\Vendor\\Smarty\\plugins\\modifier.truncate.php';
?><!doctype html>
<html lang="en">
<head>
	<meta charset="UTF-8">
...
<!--<div class="formitems inline">  -->
    <!--<label class="fi-name"><span class="colorRed">*</span> 当前搜索范围：</label>-->
    <!--<div class="form-controls">  -->
        <!--<input type="text" name='old_range' disabled="disabled" value='<?php echo $_smarty_tpl->tpl_vars['old_range']->value;?>
' placeholder="">-->
        <!--<span class="fi-help-text">单位：km</span>-->
    <!--</div>  -->
<!--</div>-->

<div class="formitems inline">  
    <label class="fi-name"><span class="colorRed">*</span> 搜索范围：</label>
    <div class="form-controls">  
        <input type="text" name='new_range' value='<?php echo $_smarty_tpl->tpl_vars['old_range']->value;?>
' placeholder="">
        <span class="fi-help-text">单位：km</span>
    </div>  
</div>
    <div class="formitems inline">
        <label class="fi-name"><span class="colorRed">*</span> 每次加载条目数：</label>
        <div class="form-controls">
            <input type="text" name='pre_near_num' value='<?php echo $_smarty_tpl->tpl_vars['config']->value['PRE_NEAR_NUM'];?>
' placeholder="">
            <span class="fi-help-text">单位：条</span>
        </div>
    </div>
<div class="formitems inline">  
    ...
    <div class="form-controls">
        ...
        <button type="submit" class="btn btn-blue"><i class="gicon-check white"></i>确定修改</button>
    </div>  
</div>
</form> 
