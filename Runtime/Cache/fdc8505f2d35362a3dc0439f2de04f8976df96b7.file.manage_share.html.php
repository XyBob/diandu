<?php /* Smarty version Smarty-3.1.6, created on 2017-07-25 18:29:52
         compiled from "C:\wamp\www\diandu\Tpl\AcpDiscountMinus\manage_share.html" */ ?>
<?php /*%%SmartyHeaderCode:1204759771da073aef7-15634359%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'fdc8505f2d35362a3dc0439f2de04f8976df96b7' => 
    array (
      0 => 'C:\\wamp\\www\\diandu\\Tpl\\AcpDiscountMinus\\manage_share.html',
      1 => 1497768721,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '1204759771da073aef7-15634359',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_59771da0c090b',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_59771da0c090b')) {function content_59771da0c090b($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_truncate')) include 'C:\\wamp\\www\\diandu\\frame\\Extend\\Vendor\\Smarty\\plugins\\modifier.truncate.php';
?><!doctype html>
<html lang="en">
<head>
	<meta charset="UTF-8">
...
<form action='' method='post' id='add_admin'>
    <input type="hidden" name='share_id' value="<?php echo $_smarty_tpl->tpl_vars['share_info']->value['share_id'];?>
">
    <div class="formitems inline">
        <label class="fi-name"><span class='colorRed'>*</span>分享标题：</label>
        <div class="form-controls">
            <input type="text" name='share_title' value="<?php echo $_smarty_tpl->tpl_vars['share_info']->value['share_title'];?>
" id='title' placeholder="" class="small">
            <span class="fi-help-text"></span>
        </div>
    </div>
    <div class="formitems inline">
        <label class="fi-name"><span class='colorRed'>*</span>分享券描述：</label>
        <div class="form-controls">
            <input type="text" name='share_desc' value="<?php echo $_smarty_tpl->tpl_vars['share_info']->value['share_desc'];?>
" id='title' placeholder="" class="small">
            <span class="fi-help-text"></span>
        </div>
    </div>
    <!--<div class="formitems inline">-->
        <!--<label class="fi-name"><span class='colorRed'>*</span>分享标题：</label>-->
        <!--<div class="form-controls">-->
            <!--<input type="text" name='business_classify_name' value="<?php echo $_smarty_tpl->tpl_vars['store_type_info']->value['business_classify_name'];?>
" id='title' placeholder="" class="small">-->
            <!--<span class="fi-help-text"></span>-->
        <!--</div>-->
    <!--</div>-->
    ...
    <!--<div class="formitems inline">-->
    <!--<label class="fi-name">&lt;!&ndash; <span class='colorRed'>*</span> &ndash;&gt;链接：</label>-->
    <!--<div class="form-controls">-->
...
' id='realname' placeholder="" class="small">-->
    ...
    <!--</div>-->
            ...
            <?php echo upload_image_widget($_smarty_tpl->tpl_vars['share_pic']->value);?>
    ...
    <div class="formitems inline">
        ...
        <div class="form-controls">
            ...
            <button type="submit" class="btn btn-blue"><i class="gicon-ok white"></i>确定</button>
