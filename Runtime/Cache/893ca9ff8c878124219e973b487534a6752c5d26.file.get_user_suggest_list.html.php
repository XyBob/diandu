<?php /* Smarty version Smarty-3.1.6, created on 2017-07-24 13:32:08
         compiled from "C:\wamp\www\diandu\Tpl\AcpUser\get_user_suggest_list.html" */ ?>
<?php /*%%SmartyHeaderCode:798159758658bdb6b0-67898865%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '893ca9ff8c878124219e973b487534a6752c5d26' => 
    array (
      0 => 'C:\\wamp\\www\\diandu\\Tpl\\AcpUser\\get_user_suggest_list.html',
      1 => 1496193340,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '798159758658bdb6b0-67898865',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_597586592ffd7',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_597586592ffd7')) {function content_597586592ffd7($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_truncate')) include 'C:\\wamp\\www\\diandu\\frame\\Extend\\Vendor\\Smarty\\plugins\\modifier.truncate.php';
    ...
    <div class="tablesWrap"> 
    	<div class="tables-searchbox">
            <div class="t-a-wait-top">
                ...
                <div class="t-a-wait-top-li"><span>意见内容：</span><input type="text" placeholder="" value="<?php echo $_smarty_tpl->tpl_vars['message']->value;?>
" class="mini" name="message"> </div>
...
" <?php if ($_smarty_tpl->tpl_vars['key']->value==$_smarty_tpl->tpl_vars['message_type']->value){?>selected<?php }?> ><?php echo $_smarty_tpl->tpl_vars['row']->value;?>
</option>-->
                    <!--<?php } ?>-->
                <!--</select>-->
                <!--</div>-->
...
?>
						<option value="<?php echo $_smarty_tpl->tpl_vars['key']->value;?>
" <?php if (is_numeric($_smarty_tpl->tpl_vars['state']->value)&&$_smarty_tpl->tpl_vars['key']->value==$_smarty_tpl->tpl_vars['state']->value){?>selected<?php }?> ><?php echo $_smarty_tpl->tpl_vars['row']->value;?>
</option>
                    <?php } ?>
                </select>
                </div>
...
<?php }?>" onclick="WdatePicker({ dateFmt:'yyyy-MM-dd'})">  
        ...
        <table class="wxtables">  
            ...
            <tbody>
				<?php  $_smarty_tpl->tpl_vars['user_suggest'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['user_suggest']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['user_suggest_list']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['user_suggest']->key => $_smarty_tpl->tpl_vars['user_suggest']->value){
$_smarty_tpl->tpl_vars['user_suggest']->_loop = true;
?>
                <tr>  
                    <td><input type="checkbox" class="checkbox" value='<?php echo $_smarty_tpl->tpl_vars['user_suggest']->value['user_suggest_id'];?>
' name="a[]"></td>
                    <!--<td><?php echo $_smarty_tpl->tpl_vars['user_suggest']->value['message_type_name'];?>
</td>  -->
                    <td><?php echo $_smarty_tpl->tpl_vars['user_suggest']->value['nickname'];?>
</td>
                    <td><?php echo $_smarty_tpl->tpl_vars['user_suggest']->value['message'];?>
</td>
                    <td><?php echo smarty_modifier_date_format($_smarty_tpl->tpl_vars['user_suggest']->value['addtime'],"%Y-%m-%d %H:%M:%S");?>
</td>
                    <td><?php echo $_smarty_tpl->tpl_vars['user_suggest']->value['state_name'];?>
</td>
                    <td>  
						<!--<a href="/AcpUser/user_detail/user_id/<?php echo $_smarty_tpl->tpl_vars['user_suggest']->value['user_id'];?>
" class="btn" title="查看用户详情">用户详情</a>   -->
						<?php if ($_smarty_tpl->tpl_vars['user_suggest']->value['message_type']==1&&$_smarty_tpl->tpl_vars['user_suggest']->value['state']==0){?>
							<a href="javascript:;" class="btn" onclick="set_state(<?php echo $_smarty_tpl->tpl_vars['user_suggest']->value['user_suggest_id'];?>
, 1)" title="标记为无用">无用</a>
							<a href="javascript:;" class="btn" onclick="set_state(<?php echo $_smarty_tpl->tpl_vars['user_suggest']->value['user_suggest_id'];?>
, 2)" title="标记为有待商榷">有待商榷</a>   
							<a href="javascript:;" class="btn" onclick="set_state(<?php echo $_smarty_tpl->tpl_vars['user_suggest']->value['user_suggest_id'];?>
, 3)" title="标记为有用">有用</a>   
							<a href="javascript:;" class="btn" onclick="set_state(<?php echo $_smarty_tpl->tpl_vars['user_suggest']->value['user_suggest_id'];?>
, 4)" title="标记为将更新到系统中">将更新到系统中</a>   
						<?php }elseif($_smarty_tpl->tpl_vars['user_suggest']->value['message_type']==1&&$_smarty_tpl->tpl_vars['user_suggest']->value['state']==2){?>
							<a href="javascript:;" class="btn" onclick="set_state(<?php echo $_smarty_tpl->tpl_vars['user_suggest']->value['user_suggest_id'];?>
, 3)" title="标记为有用">有用</a>   
							<a href="javascript:;" class="btn" onclick="set_state(<?php echo $_smarty_tpl->tpl_vars['user_suggest']->value['user_suggest_id'];?>
, 4)" title="标记为将更新到系统中">将更新到系统中</a>   
						<?php }elseif($_smarty_tpl->tpl_vars['user_suggest']->value['message_type']==1&&$_smarty_tpl->tpl_vars['user_suggest']->value['state']==3){?>
							<a href="javascript:;" class="btn" onclick="set_state(<?php echo $_smarty_tpl->tpl_vars['user_suggest']->value['user_suggest_id'];?>
, 4)" title="标记为将更新到系统中">将更新到系统中</a>   
						<?php }?>
                    </td>  
                ...
                <?php }
if (!$_smarty_tpl->tpl_vars['user_suggest']->_loop) {
?>
