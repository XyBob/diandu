<?php /* Smarty version Smarty-3.1.6, created on 2017-07-21 14:00:27
         compiled from "C:\wamp\www\diandu\Tpl\AcpMessage\add_message.html" */ ?>
<?php /*%%SmartyHeaderCode:326715971987b7d5d38-93353341%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '78dd0e35a1bdfb3b0d420cef27dbabd1bf499190' => 
    array (
      0 => 'C:\\wamp\\www\\diandu\\Tpl\\AcpMessage\\add_message.html',
      1 => 1497529396,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '326715971987b7d5d38-93353341',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5971987bc9066',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5971987bc9066')) {function content_5971987bc9066($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_truncate')) include 'C:\\wamp\\www\\diandu\\frame\\Extend\\Vendor\\Smarty\\plugins\\modifier.truncate.php';
?><!doctype html>
<html lang="en">
<head>
	<meta charset="UTF-8">
...
<form id="J_FormArticle" action="" method="post">
    <div class="formitems inline">
        ...
        <div class="form-controls">
            <input type="text" placeholder="" class="xlarge" name="message_title" id="title" value="<?php echo $_smarty_tpl->tpl_vars['message_info']->value['message_title'];?>
">
            <span class="fi-help-text hide"></span>
        </div>
    </div>
    <input type="hidden" name="isuse" value="1"  checked="checked"/>


    <div class="formitems inline">
        <label class="fi-name">页面描述：</label>
        <div class="form-controls">
            <textarea name="describe" id="description"><?php echo $_smarty_tpl->tpl_vars['message_info']->value['describe'];?>
</textarea>
        </div>
    </div>
    <div class="formitems inline">
        ...
        <div class="form-controls">
            <script id="service_providers_describe" name="message_contents" type="text/plain"><?php echo $_smarty_tpl->tpl_vars['message_info']->value['message_contents'];?>
</script>
