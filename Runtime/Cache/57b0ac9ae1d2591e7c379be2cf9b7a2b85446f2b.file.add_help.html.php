<?php /* Smarty version Smarty-3.1.6, created on 2017-07-24 13:32:13
         compiled from "C:\wamp\www\diandu\Tpl\AcpHelp\add_help.html" */ ?>
<?php /*%%SmartyHeaderCode:287015975865d0add49-35647013%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '57b0ac9ae1d2591e7c379be2cf9b7a2b85446f2b' => 
    array (
      0 => 'C:\\wamp\\www\\diandu\\Tpl\\AcpHelp\\add_help.html',
      1 => 1492838050,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '287015975865d0add49-35647013',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5975865d639c3',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5975865d639c3')) {function content_5975865d639c3($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_truncate')) include 'C:\\wamp\\www\\diandu\\frame\\Extend\\Vendor\\Smarty\\plugins\\modifier.truncate.php';
...
<div class="formitems inline">
    ...
    <div class="form-controls">
        <select name="sort_id" id="sort_id">
			...
			<?php echo smarty_function_html_options(array('options'=>$_smarty_tpl->tpl_vars['help_center_category_options']->value,'selected'=>$_smarty_tpl->tpl_vars['sort_id']->value),$_smarty_tpl);?>
...
<div class="formitems inline">
    ...
    <div class="formitems inline">
        <label class="fi-name"><!-- <span class="colorRed">*</span> -->帮助内容：</label>
        <div class="form-controls">
            <script id="service_providers_describe" name="contents" type="text/plain"><?php echo $_smarty_tpl->tpl_vars['notice_data']->value['contents'];?>
</script>
...
<script>
    UE.getEditor('service_providers_describe',{
