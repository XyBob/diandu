<?php /* Smarty version Smarty-3.1.6, created on 2017-08-01 10:45:07
         compiled from "C:\wamp\www\diandu\Tpl\AcpFinance\platform_withdraw.html" */ ?>
<?php /*%%SmartyHeaderCode:2571597fd6b18ac6e7-90301878%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '4b7a7d4a61c818ab726c0266fc99627895cd2254' => 
    array (
      0 => 'C:\\wamp\\www\\diandu\\Tpl\\AcpFinance\\platform_withdraw.html',
      1 => 1501555110,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '2571597fd6b18ac6e7-90301878',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.6',
  'unifunc' => 'content_597fd6b23be51',
  'variables' => 
  array (
    'system_config' => 0,
    'version' => 0,
...
<?php if ($_valid && !is_callable('content_597fd6b23be51')) {function content_597fd6b23be51($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_truncate')) include 'C:\\wamp\\www\\diandu\\frame\\Extend\\Vendor\\Smarty\\plugins\\modifier.truncate.php';
?><!doctype html>
<html lang="en">
<head>
	<meta charset="UTF-8">
...
<form id='base_config' action='' method='POST'>
    <div class="formitems inline">
        <label class="fi-name"><span class="colorRed">*</span> 总后台余额：</label>
        <div class="form-controls">
            <input type="text" name='old_password' value="<?php echo $_smarty_tpl->tpl_vars['left_money']->value;?>
" placeholder="" readonly>
    ...
    <div class="formitems inline">
        ...
        <div class="form-controls">
            <input type="text" name='withdraw_money' value='' placeholder="">
            <span class="fi-help-text"></span>
        </div>
    </div>
    ...
    <div class="formitems inline">
        ...
        <div class="form-controls">
            ...
            <button type="submit" class="btn btn-blue"><i class="gicon-check white"></i>确定提现</button>
        </div>
    </div>
</form>
