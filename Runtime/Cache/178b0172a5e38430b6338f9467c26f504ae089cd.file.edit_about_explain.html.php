<?php /* Smarty version Smarty-3.1.6, created on 2017-07-31 17:34:29
         compiled from "C:\wamp\www\diandu\Tpl\AcpProcess\edit_about_explain.html" */ ?>
<?php /*%%SmartyHeaderCode:25884597ef9a563c654-44860289%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '178b0172a5e38430b6338f9467c26f504ae089cd' => 
    array (
      0 => 'C:\\wamp\\www\\diandu\\Tpl\\AcpProcess\\edit_about_explain.html',
      1 => 1492764874,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '25884597ef9a563c654-44860289',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_597ef9a5a7fb0',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_597ef9a5a7fb0')) {function content_597ef9a5a7fb0($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_truncate')) include 'C:\\wamp\\www\\diandu\\frame\\Extend\\Vendor\\Smarty\\plugins\\modifier.truncate.php';
?><!doctype html>
<html lang="en">
<head>
	<meta charset="UTF-8">
...
">-->
    ...
    <div class="formitems inline">
        ...
        <div class="form-controls" id="J_KindEditor">
            <script id="editor" name="contents" type="text/plain" style="width:700px;height:500px;"><?php echo $_smarty_tpl->tpl_vars['text_contents']->value;?>
</script>
        </div>
    </div>
    <div class="formitems inline">
