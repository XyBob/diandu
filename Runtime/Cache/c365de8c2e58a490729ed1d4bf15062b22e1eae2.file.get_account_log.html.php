<?php /* Smarty version Smarty-3.1.6, created on 2017-07-03 13:49:51
         compiled from "C:\wamp\www\diandu\Tpl\McpFinance\get_account_log.html" */ ?>
<?php /*%%SmartyHeaderCode:204175959daffc5d485-61095809%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'c365de8c2e58a490729ed1d4bf15062b22e1eae2' => 
    array (
      0 => 'C:\\wamp\\www\\diandu\\Tpl\\McpFinance\\get_account_log.html',
      1 => 1493260056,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '204175959daffc5d485-61095809',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5959db002cba5',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5959db002cba5')) {function content_5959db002cba5($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_truncate')) include 'C:\\wamp\\www\\diandu\\frame\\Extend\\Vendor\\Smarty\\plugins\\modifier.truncate.php';
...
" autocomplete="off" class="Wdate" onclick="WdatePicker({ dateFmt:'yyyy-MM-dd HH:mm:ss'})">
        ...
        <label class="fi-name" style="float:right;width:60px; font-weight:normal;">￥</label>
        <label class="fi-name" style="float:right; font-weight:normal;" value="0.00"><?php echo $_smarty_tpl->tpl_vars['earns']->value;?>
</label>
        <label class="fi-name" style="float:right;width:60px; font-weight:normal;">总收益：</label>
