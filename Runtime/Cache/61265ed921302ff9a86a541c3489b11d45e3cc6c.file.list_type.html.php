<?php /* Smarty version Smarty-3.1.6, created on 2017-07-13 19:56:02
         compiled from "C:\wamp\www\diandu\Tpl\McpItemType\list_type.html" */ ?>
<?php /*%%SmartyHeaderCode:872259675fd28669a5-73383732%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '61265ed921302ff9a86a541c3489b11d45e3cc6c' => 
    array (
      0 => 'C:\\wamp\\www\\diandu\\Tpl\\McpItemType\\list_type.html',
      1 => 1496281115,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '872259675fd28669a5-73383732',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_59675fd2d1cc6',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_59675fd2d1cc6')) {function content_59675fd2d1cc6($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_truncate')) include 'C:\\wamp\\www\\diandu\\frame\\Extend\\Vendor\\Smarty\\plugins\\modifier.truncate.php';
?><!doctype html>
<html lang="en">
<head>
	<meta charset="UTF-8">
...
<div class="tablesWrap">
    <div class="tables-searchbox">
    	<a href="/McpItemType/add_type" class="btn btn-blue">添加商品类型</a>
    </div>
...
?>
            <tr>
                <td>
                	<input type="checkbox" class="checkbox" name="checkIds[]" value="<?php echo $_smarty_tpl->tpl_vars['row']->value['item_type_id'];?>
">
                </td>
                <td><?php echo $_smarty_tpl->tpl_vars['row']->value['item_type_name'];?>
</td>
                <td><?php echo $_smarty_tpl->tpl_vars['row']->value['remark'];?>
</td>
                <td>
	                <a href=<?php echo U("/McpItemType/edit_type/id/".($_smarty_tpl->tpl_vars['row']->value['item_type_id']));?>
 class="btn" title="编辑">编辑</a>
	                <a href="javascript:;" class="btn J_del" title="删除">删除</a>
                    <input type="hidden" name="item_id" value="<?php echo $_smarty_tpl->tpl_vars['row']->value['item_type_id'];?>
">
                </td>
            </tr>
            <?php }
...
?>
    ...
    <div class="tables-btmctrl clearfix">
        <div class="fl">
            ...
            <a href="###" class="btn btn-blue J_batch_del">删除</a>
        </div>
        <div class="fr">
            <div class="paginate">
...
"></script>
<script src="/Public/Js/mcp/McpItemType/list_type.js?version=<?php echo $_smarty_tpl->tpl_vars['version']->value;?>
"></script>
