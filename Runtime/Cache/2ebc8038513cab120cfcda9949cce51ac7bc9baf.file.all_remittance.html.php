<?php /* Smarty version Smarty-3.1.6, created on 2017-07-03 16:31:59
         compiled from "C:\wamp\www\diandu\Tpl\AcpFinance\all_remittance.html" */ ?>
<?php /*%%SmartyHeaderCode:6333595a00ff7c98b7-71573003%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '2ebc8038513cab120cfcda9949cce51ac7bc9baf' => 
    array (
      0 => 'C:\\wamp\\www\\diandu\\Tpl\\AcpFinance\\all_remittance.html',
      1 => 1495845316,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '6333595a00ff7c98b7-71573003',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_595a00ffdc775',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_595a00ffdc775')) {function content_595a00ffdc775($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_truncate')) include 'C:\\wamp\\www\\diandu\\frame\\Extend\\Vendor\\Smarty\\plugins\\modifier.truncate.php';
...
">  -->
		...
		<!--<select name="apply_state">-->
			<!--<option value="4" <?php if ($_smarty_tpl->tpl_vars['apply_state']->value==4){?>selected<?php }?>>&#45;&#45;请选择&#45;&#45;</option>-->
			<!--<option value="0" <?php if ($_smarty_tpl->tpl_vars['apply_state']->value==0){?>selected<?php }?> >&#45;&#45;未处理&#45;&#45;</option>-->
			<!--<option value="1" <?php if ($_smarty_tpl->tpl_vars['apply_state']->value==1){?>selected<?php }?>>&#45;&#45;已通过&#45;&#45;</option>-->
			<!--<option value="2" <?php if ($_smarty_tpl->tpl_vars['apply_state']->value==2){?>selected<?php }?>>&#45;&#45;已拒绝&#45;&#45;</option>-->
		<!--</select>-->
		<!---->
...
" autocomplete="off" class="Wdate" onclick="WdatePicker({ dateFmt:'yyyy-MM-dd HH:mm:ss'})"> -->
 ...
 $_smarty_tpl->tpl_vars['key'] = new Smarty_Variable;
 $_from = $_smarty_tpl->tpl_vars['remittance_list']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['v']->key => $_smarty_tpl->tpl_vars['v']->value){
$_smarty_tpl->tpl_vars['v']->_loop = true;
 $_smarty_tpl->tpl_vars['key']->value = $_smarty_tpl->tpl_vars['v']->key;
?>
            <tr>  
                <td><?php echo $_smarty_tpl->tpl_vars['v']->value['remittance_id'];?>
</td>
                <td><?php echo $_smarty_tpl->tpl_vars['v']->value['account'];?>
</td>
                <td><?php echo $_smarty_tpl->tpl_vars['v']->value['pay_amount'];?>
</td>
                <td><?php echo $_smarty_tpl->tpl_vars['v']->value['business_name'];?>
</td>
                <td><?php echo $_smarty_tpl->tpl_vars['v']->value['order_id'];?>
</td>
                <td><?php echo $_smarty_tpl->tpl_vars['v']->value['remark'];?>
</td>
                <td><?php if ($_smarty_tpl->tpl_vars['v']->value['reqnbr']){?><?php echo $_smarty_tpl->tpl_vars['v']->value['reqnbr'];?>
<?php }else{ ?>无查询码<?php }?></td>
                <td><?php echo smarty_modifier_date_format($_smarty_tpl->tpl_vars['v']->value['addtime'],"%Y-%m-%d %H:%M:%S");?>
</td>
                <td>
                    <!--<a href="javascript:;"  onclick="re_pay_to_bank(<?php echo $_smarty_tpl->tpl_vars['v']->value['remittance_id'];?>
)" class="btn" title="重新打款">重新打款</a>-->
                    <?php if ($_smarty_tpl->tpl_vars['v']->value['reqnbr']){?>
                    <a href="javascript:;"  onclick="bank_pay_result_search('<?php echo $_smarty_tpl->tpl_vars['v']->value['reqnbr'];?>
')" class="btn" title="查询结果">查询打款结果</a>
                    <?php }?>
                </td>
            </tr>
			<?php }
