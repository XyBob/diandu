<?php /* Smarty version Smarty-3.1.6, created on 2017-07-03 14:54:16
         compiled from "C:\wamp\www\diandu\Tpl\AcpOrder\get_order_list.html" */ ?>
<?php /*%%SmartyHeaderCode:206965959ea18683358-92544513%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'e3b609410bf18718121a42a49c9deff20992bf0f' => 
    array (
      0 => 'C:\\wamp\\www\\diandu\\Tpl\\AcpOrder\\get_order_list.html',
      1 => 1498634474,
      2 => 'file',
    ),
    ...
    '35c19ea61b9f5dd053292bff5c1068c525b75d14' => 
    array (
      0 => 'C:\\wamp\\www\\diandu\\Tpl\\AcpOrder\\Public_forms.html',
      1 => 1498634391,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '206965959ea18683358-92544513',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5959ea190ae94',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5959ea190ae94')) {function content_5959ea190ae94($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_truncate')) include 'C:\\wamp\\www\\diandu\\frame\\Extend\\Vendor\\Smarty\\plugins\\modifier.truncate.php';
...
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate("./Public_forms.html", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0, '206965959ea18683358-92544513');
content_5959ea1893cb2($_smarty_tpl);
...
<?php }else{ ?>&#45;&#45;<?php }?></td> -->
			...
			<td><?php if ($_smarty_tpl->tpl_vars['order_info']->value['type']==1){?>到店消费<?php }elseif($_smarty_tpl->tpl_vars['order_info']->value['type']==2){?>外卖订单<?php }?></td>
...
" class="btn" title="修改">编辑</a>
				<a href="/AcpOrder/user_detail/user_id/<?php echo $_smarty_tpl->tpl_vars['order_info']->value['user_id'];?>
" class="btn" title="查看用户">查看用户</a>
				<a href="/AcpOrder/business_detail/business_id/<?php echo $_smarty_tpl->tpl_vars['order_info']->value['business_id'];?>
" class="btn" title="查看商家">查看商家</a>
				<a href="javascript:;" class="btn" title="删除" onclick="delete_order(<?php echo $_smarty_tpl->tpl_vars['order_info']->value['order_id'];?>
)">删除</a>
				<?php if ($_smarty_tpl->tpl_vars['order_info']->value['order_status']==6){?>
				<a href="javascript:;" class="btn" title="同意退款" onclick="agree_refund(<?php echo $_smarty_tpl->tpl_vars['order_info']->value['order_id'];?>
,1)">同意退款</a>
				<a href="javascript:;" class="btn" title="拒绝退款" onclick="agree_refund(<?php echo $_smarty_tpl->tpl_vars['order_info']->value['order_id'];?>
,0)">拒绝退款</a>
				<?php }?>
...
<script>
	...
	function agree_refund(order_id,flag){

				$.ajax({
					url: "/AcpOrder/agree_refund", //URL
					dataType: "json",
...
<?php }} ?><?php /* Smarty version Smarty-3.1.6, created on 2017-07-03 14:54:16
         compiled from "C:\wamp\www\diandu\Tpl\AcpOrder\Public_forms.html" */ ?>
<?php if ($_valid && !is_callable('content_5959ea1893cb2')) {function content_5959ea1893cb2($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include 'C:\\wamp\\www\\diandu\\frame\\Extend\\Vendor\\Smarty\\plugins\\modifier.date_format.php';
