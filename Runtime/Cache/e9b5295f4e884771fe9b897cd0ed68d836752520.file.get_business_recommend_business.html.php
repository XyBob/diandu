<?php /* Smarty version Smarty-3.1.6, created on 2017-08-01 15:06:30
         compiled from "C:\wamp\www\diandu\Tpl\AcpUser\get_business_recommend_business.html" */ ?>
<?php /*%%SmartyHeaderCode:2581859802876e97c07-26396266%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'e9b5295f4e884771fe9b897cd0ed68d836752520' => 
    array (
      0 => 'C:\\wamp\\www\\diandu\\Tpl\\AcpUser\\get_business_recommend_business.html',
      1 => 1494221962,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '2581859802876e97c07-26396266',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5980287749d4e',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5980287749d4e')) {function content_5980287749d4e($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_truncate')) include 'C:\\wamp\\www\\diandu\\frame\\Extend\\Vendor\\Smarty\\plugins\\modifier.truncate.php';
?><!doctype html>
<html lang="en">
<head>
	<meta charset="UTF-8">
...
">
                ...
                <input type="text" name="mobile" id="mobile" value="<?php echo $_smarty_tpl->tpl_vars['mobile']->value;?>
">
...
%
            ...
            <td><?php if ($_smarty_tpl->tpl_vars['this']->value['industry_id']==1){?>普通店铺<?php }else{ ?>菜市场<?php }?></td>
        </tr>
        <?php } ?>
        <?php }else{ ?>
        <tr>
