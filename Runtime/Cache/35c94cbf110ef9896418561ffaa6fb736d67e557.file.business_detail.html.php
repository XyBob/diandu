<?php /* Smarty version Smarty-3.1.6, created on 2017-07-24 13:49:30
         compiled from "C:\wamp\www\diandu\Tpl\AcpOrder\business_detail.html" */ ?>
<?php /*%%SmartyHeaderCode:324559758a6aa53438-38646801%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '35c94cbf110ef9896418561ffaa6fb736d67e557' => 
    array (
      0 => 'C:\\wamp\\www\\diandu\\Tpl\\AcpOrder\\business_detail.html',
      1 => 1493277109,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '324559758a6aa53438-38646801',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_59758a6b071f1',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_59758a6b071f1')) {function content_59758a6b071f1($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_truncate')) include 'C:\\wamp\\www\\diandu\\frame\\Extend\\Vendor\\Smarty\\plugins\\modifier.truncate.php';
?><!doctype html>
<html lang="en">
<head>
	<meta charset="UTF-8">
...
" style="width:50px;"></td>
            ...
            <tr>
                <td class="tables-form-title">商家名字：</td>
                <td><?php echo $_smarty_tpl->tpl_vars['business_info']->value['business_name'];?>
</td>
            </tr>
            <tr>
                <td class="tables-form-title">联系人：</td>
                <td><?php echo $_smarty_tpl->tpl_vars['business_info']->value['contacts'];?>
</td>
            </tr>
            <tr>
                <td class="tables-form-title">联系人电话：</td>
                <td><?php if ($_smarty_tpl->tpl_vars['business_info']->value['contact_number']){?><?php echo $_smarty_tpl->tpl_vars['business_info']->value['contact_number'];?>
<?php }else{ ?>--<?php }?></td>
            </tr>
            <tr>
                <td class="tables-form-title">店铺分类：</td>
                <td><?php if ($_smarty_tpl->tpl_vars['business_info']->value['business_classify']){?><?php echo $_smarty_tpl->tpl_vars['business_info']->value['business_classify'];?>
<?php }else{ ?>--<?php }?></td>
            </tr>
            <tr>
                <td class="tables-form-title">行业：</td>
                <td><?php if ($_smarty_tpl->tpl_vars['business_info']->value['industry_id']==1){?>普通商店<?php }else{ ?>菜市场<?php }?></td>
            </tr>
            <tr>
                <td class="tables-form-title">让利：</td>
                <td><?php if ($_smarty_tpl->tpl_vars['business_info']->value['rate']){?><?php echo $_smarty_tpl->tpl_vars['business_info']->value['rate'];?>
%<?php }else{ ?>--<?php }?></td>
            </tr>
            <tr>
                <td class="tables-form-title">人均消费：</td>
                <td><?php if ($_smarty_tpl->tpl_vars['business_info']->value['consumption']){?><?php echo $_smarty_tpl->tpl_vars['business_info']->value['consumption'];?>
<?php }else{ ?>--<?php }?></td>
            </tr>
            <tr>
                <td class="tables-form-title">省：</td>
                <td><?php if ($_smarty_tpl->tpl_vars['business_info']->value['province']){?><?php echo $_smarty_tpl->tpl_vars['business_info']->value['province'];?>
<?php }else{ ?>--<?php }?></td>
            </tr>
            <tr>
                <td class="tables-form-title">市：</td>
                <td><?php if ($_smarty_tpl->tpl_vars['business_info']->value['city']){?><?php echo $_smarty_tpl->tpl_vars['business_info']->value['city'];?>
<?php }else{ ?>--<?php }?></td>
            </tr>
            <tr>
                <td class="tables-form-title">县：</td>
                <td><?php if ($_smarty_tpl->tpl_vars['business_info']->value['area']){?><?php echo $_smarty_tpl->tpl_vars['business_info']->value['area'];?>
<?php }else{ ?>--<?php }?></td>
            </tr>
            <tr>
                <td class="tables-form-title">详细地址：</td>
                <td><?php if ($_smarty_tpl->tpl_vars['business_info']->value['address']){?><?php echo $_smarty_tpl->tpl_vars['business_info']->value['address'];?>
<?php }else{ ?>--<?php }?></td>
            </tr>
            <tr>
                <td class="tables-form-title">简介：</td>
                <td><?php if ($_smarty_tpl->tpl_vars['business_info']->value['desc']){?><?php echo $_smarty_tpl->tpl_vars['business_info']->value['desc'];?>
<?php }else{ ?>--<?php }?></td>
            </tr>
            <tr>
                <td class="tables-form-title">店招图片：</td>
                <td><img src="<?php echo $_smarty_tpl->tpl_vars['business_info']->value['sign_pic'];?>
" width="10%" ></td>
            </tr>
            <tr>
 ...
 $_from = $_smarty_tpl->tpl_vars['evn_pic']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['this']->key => $_smarty_tpl->tpl_vars['this']->value){
$_smarty_tpl->tpl_vars['this']->_loop = true;
?>
                    <img src="<?php echo $_smarty_tpl->tpl_vars['this']->value;?>
" width="10%" >
                    <?php } ?>
                </td>
            </tr>
            <tr>
                ...
                <td><img src="<?php echo $_smarty_tpl->tpl_vars['business_info']->value['license_pic'];?>
 " width="10%"></td>
            </tr>
            </tbody>
        </table>
