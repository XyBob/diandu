<?php /* Smarty version Smarty-3.1.6, created on 2017-08-01 15:02:37
         compiled from "C:\wamp\www\diandu\Tpl\AcpUser\get_business_recommend.html" */ ?>
<?php /*%%SmartyHeaderCode:204335980278d661af2-48057893%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '81f303ac1f5ddbff588f441f1de83d8949677043' => 
    array (
      0 => 'C:\\wamp\\www\\diandu\\Tpl\\AcpUser\\get_business_recommend.html',
      1 => 1493188704,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '204335980278d661af2-48057893',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5980278dd0c68',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5980278dd0c68')) {function content_5980278dd0c68($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_truncate')) include 'C:\\wamp\\www\\diandu\\frame\\Extend\\Vendor\\Smarty\\plugins\\modifier.truncate.php';
        ...
        <div class="tables-searchbox">
            <div class="t-a-wait-top">
                <form action="" method="post" id="rank_waiting">
                    <div class="t-a-wait-top-li"><span>用户昵称：</span><input type="text" placeholder="" value="<?php echo $_smarty_tpl->tpl_vars['username']->value;?>
...
<?php }?>" onclick="WdatePicker({ dateFmt:'yyyy-MM-dd'})">
        ...
        <table class="wxtables">
            <colgroup>
                <col width="5%">
                <col width="7%">
                <?php if ($_smarty_tpl->tpl_vars['opt']->value=='user'){?><col width="7%">  <?php }?>
                <col width="7%">
                <col width="7%">
                <?php if ($_smarty_tpl->tpl_vars['opt']->value=='user'){?><col width="7%"> <?php }?>
                <col width="15%">
