<?php /* Smarty version Smarty-3.1.6, created on 2017-07-24 13:32:06
         compiled from "C:\wamp\www\diandu\Tpl\AcpDiscountMinus\get_discount_minus_list.html" */ ?>
<?php /*%%SmartyHeaderCode:2612259758656627ce6-68433339%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'a153b3cb5dc314433e40d8fc4f8f251295f5c6b4' => 
    array (
      0 => 'C:\\wamp\\www\\diandu\\Tpl\\AcpDiscountMinus\\get_discount_minus_list.html',
      1 => 1492479463,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '2612259758656627ce6-68433339',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_59758656be4c6',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_59758656be4c6')) {function content_59758656be4c6($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_truncate')) include 'C:\\wamp\\www\\diandu\\frame\\Extend\\Vendor\\Smarty\\plugins\\modifier.truncate.php';
...
<?php }?>" onclick="WdatePicker({ dateFmt:'yyyy-MM-dd'})">
        ...
        <table class="wxtables">
            ...
            <?php  $_smarty_tpl->tpl_vars['discount_item'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['discount_item']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['discount_list']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['discount_item']->key => $_smarty_tpl->tpl_vars['discount_item']->value){
$_smarty_tpl->tpl_vars['discount_item']->_loop = true;
?>
            <tbody class="combo-tbody">
            <tr>
                <!-- <td><input type="checkbox" class="checkbox" value='<?php echo $_smarty_tpl->tpl_vars['discount_item']->value['discount_minus_id'];?>
' name="a[]"></td> -->
                <td><?php echo $_smarty_tpl->tpl_vars['discount_item']->value['title'];?>
</td>
                <td><?php echo $_smarty_tpl->tpl_vars['discount_item']->value['amount_limit'];?>
</td>
                <td><?php echo $_smarty_tpl->tpl_vars['discount_item']->value['num'];?>
</td>
                <td><?php echo smarty_modifier_date_format($_smarty_tpl->tpl_vars['discount_item']->value['start_time'],"%Y-%m-%d %H:%M:%S");?>
 -- <?php echo smarty_modifier_date_format($_smarty_tpl->tpl_vars['discount_item']->value['end_time'],"%Y-%m-%d %H:%M:%S");?>
</td>
                <td>
                    <a href="/AcpDiscountMinus/edit_discount_minus/discount_minus_id/<?php echo $_smarty_tpl->tpl_vars['discount_item']->value['discount_minus_id'];?>
" class="btn" title="修改">修改</a>
                    <a href="/AcpDiscountMinus/get_discount_minus_detail/discount_id/<?php echo $_smarty_tpl->tpl_vars['discount_item']->value['discount_minus_id'];?>
" class="btn" title="查看活动明细">查看活动明细</a>
                </td>
            </tr>
            </tbody>
            <?php }
if (!$_smarty_tpl->tpl_vars['discount_item']->_loop) {
?>
            <tbody>
            <tr>
                <td colspan="7">
