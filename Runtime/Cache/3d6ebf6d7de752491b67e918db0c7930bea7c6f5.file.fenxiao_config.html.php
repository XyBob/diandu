<?php /* Smarty version Smarty-3.1.6, created on 2017-07-24 13:54:22
         compiled from "C:\wamp\www\diandu\Tpl\AcpConfig\fenxiao_config.html" */ ?>
<?php /*%%SmartyHeaderCode:2922959758b8ee4eaa7-10153157%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '3d6ebf6d7de752491b67e918db0c7930bea7c6f5' => 
    array (
      0 => 'C:\\wamp\\www\\diandu\\Tpl\\AcpConfig\\fenxiao_config.html',
      1 => 1495845316,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '2922959758b8ee4eaa7-10153157',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_59758b8f40da5',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_59758b8f40da5')) {function content_59758b8f40da5($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_truncate')) include 'C:\\wamp\\www\\diandu\\frame\\Extend\\Vendor\\Smarty\\plugins\\modifier.truncate.php';
?><!doctype html>
<html lang="en">
<head>
	<meta charset="UTF-8">
...
<!--<div class="formitems inline">-->
    <!--<label class="fi-name">开启分销模式：</label>-->
    <!--<div class="form-controls">-->
        <!--<div class="radio-group">-->
			<!--<label><input type="radio" name="is_fenxiao_open" value="1" <?php if ($_smarty_tpl->tpl_vars['config']->value['IS_FENXIAO_OPEN']==1){?>checked="checked"<?php }?> />是</label>-->
            <!--<label><input type="radio" name="is_fenxiao_open" value="0" <?php if ($_smarty_tpl->tpl_vars['config']->value['IS_FENXIAO_OPEN']==0){?>checked="checked"<?php }?> />否</label>   -->
        <!--</div>-->
    <!--</div>-->
<!--</div>-->

<!--<div class="formitems inline">  -->
    <!--<label class="fi-name"><span class="colorRed">*</span>分销级数：</label>  -->
    <!--<div class="form-controls">  -->
    <!--<select name="fenxiao_level" id="fenxiao_level" onchange="change_level();">-->
    <!--<option value="0">&#45;&#45;请选择&#45;&#45;</option>-->
	<!--<option value="1" <?php if ($_smarty_tpl->tpl_vars['config']->value['FENXIAO_LEVEL']==1){?>selected<?php }?>>一级分销</option>-->
    <!--<option value="2" <?php if ($_smarty_tpl->tpl_vars['config']->value['FENXIAO_LEVEL']==2){?>selected<?php }?>>二级分销</option>-->
    <!--<option value="3" <?php if ($_smarty_tpl->tpl_vars['config']->value['FENXIAO_LEVEL']==3){?>selected<?php }?>>三级分销</option>-->
    <!--</select>-->
...
<div class="formitems inline">  
    <label class="fi-name">省级代理提成比例：</label>
    <div class="form-controls">  
        <input type="text" name='first_level_agent_rate' value='<?php echo $_smarty_tpl->tpl_vars['config']->value['FIRST_LEVEL_AGENT_RATE'];?>
' placeholder="">%
...
<div class="formitems inline">  
    <label class="fi-name">市级代理提成比例：</label>
    <div class="form-controls">  
        <input type="text" name='second_level_agent_rate' value='<?php echo $_smarty_tpl->tpl_vars['config']->value['SECOND_LEVEL_AGENT_RATE'];?>
' placeholder="">%
        <span class="fi-help-text"></span>
    </div>  
</div> 
...
<div class="formitems inline">  
    <label class="fi-name">县、区级代理提成比例：</label>
    <div class="form-controls">  
        <input type="text" name='third_level_agent_rate' value='<?php echo $_smarty_tpl->tpl_vars['config']->value['THIRD_LEVEL_AGENT_RATE'];?>
' placeholder="">%
        <span class="fi-help-text"></span>
    </div>  
</div>
    ...
    <div class="formitems inline">
        <label class="fi-name">店铺推荐人提成比例：</label>
        <div class="form-controls">
            <input type="text" name='business_rate' value='<?php echo $_smarty_tpl->tpl_vars['config']->value['BUSINESS_RATE'];?>
' placeholder="">%
            <span class="fi-help-text"></span>
        </div>
    </div>
    ...
    <div class="formitems inline">
        <label class="fi-name">个人推荐人提成比例：</label>
        <div class="form-controls">
            <input type="text" name='personal_rate' value='<?php echo $_smarty_tpl->tpl_vars['config']->value['PERSONAL_RATE'];?>
' placeholder="">%
            <span class="fi-help-text"></span>
        </div>
    </div>
    ...
    <div class="formitems inline">
        <label class="fi-name">系统服务费率：</label>
        <div class="form-controls">
            <input type="text" name='system_rate' value='<?php echo $_smarty_tpl->tpl_vars['config']->value['SYSTEM_RATE'];?>
' placeholder="">%
            <span class="fi-help-text"></span>
        </div>
    </div>
    ...
    <div class="formitems inline">
        <label class="fi-name">店铺让利比例：</label>
        <div class="form-controls">
            <input type="text" name='all_business_rate' value='<?php echo $_smarty_tpl->tpl_vars['config']->value['ALL_BUSINESS_RATE'];?>
' placeholder="">%
            <span class="fi-help-text"></span>
        </div>
    </div>
