<?php /* Smarty version Smarty-3.1.6, created on 2017-08-01 15:04:08
         compiled from "C:\wamp\www\diandu\Tpl\FrontUserCenter\my_recom_person.html" */ ?>
<?php /*%%SmartyHeaderCode:100598027e8f185a6-78281537%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'af19357bb3b2a862770773dce09f76a8f408313c' => 
    array (
      0 => 'C:\\wamp\\www\\diandu\\Tpl\\FrontUserCenter\\my_recom_person.html',
      1 => 1497693686,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '100598027e8f185a6-78281537',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_598027e95a5fe',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_598027e95a5fe')) {function content_598027e95a5fe($_smarty_tpl) {?><?php if ($_smarty_tpl->tpl_vars['pc_site']->value==1){?>
<!doctype html>
...
"/>
	<link rel="stylesheet" type="text/css" href="__PUBLIC__/Css/front/front_css/recom_list.css?version=<?php echo $_smarty_tpl->tpl_vars['version']->value;?>
"/>
	<style type="text/css">
		i{
...
<body>
	...
	<div class="header">
	    ...
	    <h1>我推荐的个人</h1><!--todo 一期-->
	</div>
	<div id="load_wrapper">
		<div id="scroller" style="<?php if ($_smarty_tpl->tpl_vars['my_recom_person_list']->value){?>display:block;<?php }else{ ?>display:none;<?php }?>">
			<div id="pullDown" <?php if ($_smarty_tpl->tpl_vars['is_wechat']->value==1){?>style="display:none"<?php }?>>
			    <span class="pullDownIcon"></span>
			</div>
			<div class="person_list_wrap">
				<?php  $_smarty_tpl->tpl_vars['this'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['this']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['my_recom_person_list']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
...
?>
				<div class="person_list clearfix">
					<img src="<?php echo $_smarty_tpl->tpl_vars['this']->value['headimgurl'];?>
" class="person_img fl"/>
					<div class="peron_intro fl">
						<p class="person_name"><?php echo $_smarty_tpl->tpl_vars['this']->value['nickname'];?>
</p>
						<div class="person_time">
							<!--<i class="icon_add_person shijian"></i>-->
							<span class="time"><?php echo date('Y-m-d',$_smarty_tpl->tpl_vars['this']->value['reg_time']);?>
</span>
						</div>
					</div>
				</div>
		...
		<p class="total_none" style="<?php if ($_smarty_tpl->tpl_vars['my_recom_person_list']->value){?>display:none;<?php }else{ ?>display:block;<?php }?>">暂无推荐的个人</p>
	</div>
...
';
	...
	<script type="text/javascript" src="__PUBLIC__/Js/front/front_js/my_recom_person_list.js"></script>
