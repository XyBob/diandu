<?php /* Smarty version Smarty-3.1.6, created on 2017-07-03 13:36:12
         compiled from "C:\wamp\www\diandu\Tpl\UcpFinance\bind_bank.html" */ ?>
<?php /*%%SmartyHeaderCode:276075959d7cc759a14-24251314%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '003443631c4d1e17c53ce811abccfaaf5e21e9b1' => 
    array (
      0 => 'C:\\wamp\\www\\diandu\\Tpl\\UcpFinance\\bind_bank.html',
      1 => 1492825648,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '276075959d7cc759a14-24251314',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5959d7ccc870c',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5959d7ccc870c')) {function content_5959d7ccc870c($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_truncate')) include 'C:\\wamp\\www\\diandu\\frame\\Extend\\Vendor\\Smarty\\plugins\\modifier.truncate.php';
?><!doctype html>
<html lang="en">
<head>
	<meta charset="UTF-8">
...
<?php if ($_smarty_tpl->tpl_vars['is_bind']->value!=1){?>
<form id='base_config' action='' method='POST'>
<div class="formitems inline">  
    <label class="fi-name"><span class="colorRed">*</span> 银行卡卡号：</label>
    <div class="form-controls">  
        <input type="number" name='account' value='<?php echo $_smarty_tpl->tpl_vars['bank_card_info']->value['account'];?>
' placeholder="">
...
<div class="formitems inline">  
    ...
    <div class="form-controls">  
        <input type="text" name='realname' required value='<?php echo $_smarty_tpl->tpl_vars['bank_card_info']->value['realname'];?>
' placeholder="">
        <span class="fi-help-text"></span>  
    </div>  
</div>
...
<div class="formitems inline">  
    <label class="fi-name"><span class="colorRed">*</span> 银行名称：</label>
    <div class="form-controls">  
        <!--<input type="text" name='bank_name' required value='<?php echo $_smarty_tpl->tpl_vars['bank_card_info']->value['bank_name'];?>
' placeholder="">-->
        <!--<span class="fi-help-text"></span>  -->
...
" <?php if ($_smarty_tpl->tpl_vars['bank']->value['bank_id']==$_smarty_tpl->tpl_vars['bank_card_info']->value['bank_id']){?>selected<?php }?>><?php echo $_smarty_tpl->tpl_vars['bank']->value['bank_name'];?>
</option>
            <?php } ?>
        </select>
    </div>  
    ...
    <div class="formitems inline">
        ...
        <div class="form-controls">
            <input type="text" name='opening_bank' required value='<?php echo $_smarty_tpl->tpl_vars['bank_card_info']->value['opening_bank'];?>
' placeholder="">
            <span class="fi-help-text"></span>
    ...
    <!--<div class="formitems inline">-->
        <!--<label class="fi-name"><span class="colorRed">*</span> 预留手机号码：</label>-->
        <!--<div class="form-controls">-->
            <!--<input type="number" name='bank_mobile' required value='<?php echo $_smarty_tpl->tpl_vars['bank_card_info']->value['bank_mobile'];?>
' placeholder="">-->
            <!--<span class="fi-help-text"></span>-->
        <!--</div>-->
    <!--</div>-->
...
<div class="formitems inline">  
    ...
    <div class="form-controls">
        ...
        <button type="submit" class="btn btn-blue"><i class="gicon-check white"></i>绑定</button>
    </div>  
</div>
</form>
<?php }else{ ?>
<label class="fi-help-text" style="color:red;">已完成绑定</label><br />
<a href="/UcpFinance/edit_bank_info/bank_card_id/<?php echo $_smarty_tpl->tpl_vars['bank_card_id']->value;?>
" class="btn btn-blue" title="编辑银行卡信息">编辑银行卡信息</a>
<?php }?>
