<?php /* Smarty version Smarty-3.1.6, created on 2017-08-03 10:22:03
         compiled from "C:\wamp\www\diandu\Tpl\McpOrder\get_order_list.html" */ ?>
<?php /*%%SmartyHeaderCode:16657598288cb0490f6-03647914%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '44f41f905ecbf04b1bdd027566162007a648891a' => 
    array (
      0 => 'C:\\wamp\\www\\diandu\\Tpl\\McpOrder\\get_order_list.html',
      1 => 1498634462,
      2 => 'file',
    ),
    ...
    '05483e6bf004ed7816091c34395b8cfea9f48811' => 
    array (
      0 => 'C:\\wamp\\www\\diandu\\Tpl\\McpOrder\\Public_forms.html',
      1 => 1498629750,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '16657598288cb0490f6-03647914',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_598288cb887ea',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_598288cb887ea')) {function content_598288cb887ea($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_truncate')) include 'C:\\wamp\\www\\diandu\\frame\\Extend\\Vendor\\Smarty\\plugins\\modifier.truncate.php';
...
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate("./Public_forms.html", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0, '16657598288cb0490f6-03647914');
content_598288cb3092a($_smarty_tpl);
...
<?php }else{ ?>&#45;&#45;<?php }?></td> -->
				...
				<td>
					<span><?php echo $_smarty_tpl->tpl_vars['order_info']->value['status'];?>
</span>
				</td>
				<td><?php if ($_smarty_tpl->tpl_vars['order_info']->value['type']==1){?>到店消费<?php }elseif($_smarty_tpl->tpl_vars['order_info']->value['type']==2){?>外卖订单<?php }elseif($_smarty_tpl->tpl_vars['order_info']->value['type']==3){?>商家申请<?php }?></td>
                <td>  
					<a href="/McpOrder/order_detail/order_id/<?php echo $_smarty_tpl->tpl_vars['order_info']->value['order_id'];?>
/redirect/<?php echo $_smarty_tpl->tpl_vars['redirect']->value;?>
" class="btn" title="查看">查看</a>
						<!--<a href="/McpOrder/edit_order/order_id/<?php echo $_smarty_tpl->tpl_vars['order_info']->value['order_id'];?>
/redirect/<?php echo $_smarty_tpl->tpl_vars['redirect']->value;?>
...
"></script>
<script src="__JS__/mcp/McpOrder/order.js?version=<?php echo $_smarty_tpl->tpl_vars['version']->value;?>
"></script>
<script src="__JS__/mcp/McpOrder/get_pre_stockup_order_list.js?version=<?php echo $_smarty_tpl->tpl_vars['version']->value;?>
"></script>
<script src="__JS__/mcp/McpOrder/get_pre_deliver_order_list.js?version=<?php echo $_smarty_tpl->tpl_vars['version']->value;?>
"></script>
<script src="__JS__/lodop/LodopFuncs.js?version=<?php echo $_smarty_tpl->tpl_vars['version']->value;?>
"></script>
<script src="__JS__/mcp/McpOrder/print_shipping.js?version=<?php echo $_smarty_tpl->tpl_vars['version']->value;?>
"></script>
<script src="__JS__/clipboard.min.js"></script>
...
<?php }} ?><?php /* Smarty version Smarty-3.1.6, created on 2017-08-03 10:22:03
         compiled from "C:\wamp\www\diandu\Tpl\McpOrder\Public_forms.html" */ ?>
<?php if ($_valid && !is_callable('content_598288cb3092a')) {function content_598288cb3092a($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include 'C:\\wamp\\www\\diandu\\frame\\Extend\\Vendor\\Smarty\\plugins\\modifier.date_format.php';
...
"> </div>
			<select class="small" name="type">
				...
				<option value="1" <?php if ($_smarty_tpl->tpl_vars['type']->value==1){?>selected<?php }?>>到店消费</option>
				<option value="2" <?php if ($_smarty_tpl->tpl_vars['type']->value==2){?>selected<?php }?>>外卖</option>
				<option value="3" <?php if ($_smarty_tpl->tpl_vars['type']->value==3){?>selected<?php }?>>商家申请</option>
			</select>
