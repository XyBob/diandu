<?php /* Smarty version Smarty-3.1.6, created on 2017-07-24 13:54:26
         compiled from "C:\wamp\www\diandu\Tpl\AcpConfig\business_fenxiao_config.html" */ ?>
<?php /*%%SmartyHeaderCode:3003159758b922c1e21-23073967%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '732fd94511db97c3db6e9baec3b88c200a86df9d' => 
    array (
      0 => 'C:\\wamp\\www\\diandu\\Tpl\\AcpConfig\\business_fenxiao_config.html',
      1 => 1493365822,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '3003159758b922c1e21-23073967',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_59758b927ae37',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_59758b927ae37')) {function content_59758b927ae37($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_truncate')) include 'C:\\wamp\\www\\diandu\\frame\\Extend\\Vendor\\Smarty\\plugins\\modifier.truncate.php';
?><!doctype html>
<html lang="en">
<head>
	<meta charset="UTF-8">
...
<div class="formitems inline">  
    ...
    <div class="form-controls">  
        <input type="text" name='join_prov_rate' value='<?php echo $_smarty_tpl->tpl_vars['config']->value['JOIN_PROV_RATE'];?>
' placeholder="">%
...
<div class="formitems inline">  
    ...
    <div class="form-controls">  
        <input type="text" name='join_city_rate' value='<?php echo $_smarty_tpl->tpl_vars['config']->value['JOIN_CITY_RATE'];?>
' placeholder="">%
        <span class="fi-help-text"></span>
    </div>  
</div> 
...
<div class="formitems inline">  
    ...
    <div class="form-controls">  
        <input type="text" name='join_area_rate' value='<?php echo $_smarty_tpl->tpl_vars['config']->value['JOIN_AREA_RATE'];?>
' placeholder="">%
        <span class="fi-help-text"></span>
    </div>  
</div>
    ...
    <div class="formitems inline">
        ...
        <div class="form-controls">
            <input type="text" name='join_business_rate' value='<?php echo $_smarty_tpl->tpl_vars['config']->value['JOIN_BUSINESS_RATE'];?>
' placeholder="">%
            <span class="fi-help-text"></span>
        </div>
    </div>
...
' placeholder="">%
    ...
    <div class="formitems inline">
        <label class="fi-name">商家申请费设置：</label>
        <div class="form-controls">
            <input type="text" name='business_apply' value='<?php echo $_smarty_tpl->tpl_vars['config']->value['BUSINESS_APPLY'];?>
' placeholder="">
            <span class="fi-help-text"></span>
        </div>
    </div>
    ...
    <!--<div class="formitems inline">-->
        ...
        <!--<div class="form-controls">-->
            <!--<input type="text" name='join_personal_rate' value='<?php echo $_smarty_tpl->tpl_vars['config']->value['JOIN_PERSONAL_RATE'];?>
' placeholder="">%-->
            <!--<span class="fi-help-text"></span>-->
        <!--</div>-->
    <!--</div>-->
