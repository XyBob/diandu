<?php /* Smarty version Smarty-3.1.6, created on 2017-07-24 14:06:09
         compiled from "C:\wamp\www\diandu\Tpl\AcpUser\get_all_user.html" */ ?>
<?php /*%%SmartyHeaderCode:1833859758e510c4230-33951059%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'a30f97f532a4b040639a344d04a124bdd1e5ad35' => 
    array (
      0 => 'C:\\wamp\\www\\diandu\\Tpl\\AcpUser\\get_all_user.html',
      1 => 1493718943,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '1833859758e510c4230-33951059',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_59758e52500c6',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_59758e52500c6')) {function content_59758e52500c6($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_truncate')) include 'C:\\wamp\\www\\diandu\\frame\\Extend\\Vendor\\Smarty\\plugins\\modifier.truncate.php';
...
<?php }?>" onclick="WdatePicker({ dateFmt:'yyyy-MM-dd'})">
        ...
        <table class="wxtables">
            ...
            <tr>
                ...
                <?php }?>
                <td><?php echo $_smarty_tpl->tpl_vars['count_shop']->value;?>
</td>                <!--			<td><input type="checkbox" class="checkbox" value='<?php echo $_smarty_tpl->tpl_vars['user']->value['user_id'];?>
' name="a[]"></td>-->
                <!--
                ...
                <td><?php echo smarty_modifier_date_format($_smarty_tpl->tpl_vars['start_time']->value,"%Y-%m-%d");?>
--<?php echo smarty_modifier_date_format($_smarty_tpl->tpl_vars['end_time']->value,"%Y-%m-%d");?>
</td>
