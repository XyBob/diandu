<?php /* Smarty version Smarty-3.1.6, created on 2017-08-01 15:10:27
         compiled from "C:\wamp\www\diandu\Tpl\AcpConfig\subscribe_set.html" */ ?>
<?php /*%%SmartyHeaderCode:1262659802963ac8a96-02529644%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'a648e29f08d209d2cebb95802923a0b0038005e2' => 
    array (
      0 => 'C:\\wamp\\www\\diandu\\Tpl\\AcpConfig\\subscribe_set.html',
      1 => 1495845316,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '1262659802963ac8a96-02529644',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_59802963f410f',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_59802963f410f')) {function content_59802963f410f($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_truncate')) include 'C:\\wamp\\www\\diandu\\frame\\Extend\\Vendor\\Smarty\\plugins\\modifier.truncate.php';
?><!doctype html>
<html lang="en">
<head>
	<meta charset="UTF-8">
...
<div class="formitems inline">
    <label class="fi-name"><span class="colorRed">*</span>图文标题：</label>
    <div class="form-controls">
        <input type="text" placeholder="" class="xlarge" name="subscribe_title" id="subscribe_title" value="<?php echo $_smarty_tpl->tpl_vars['config']->value['SUBSCRIBE_TITLE'];?>
">
...
<div class="formitems inline">
    <label class="fi-name"><span class="colorRed">*</span>图文链接：</label>
    <div class="form-controls">
        <input type="text" placeholder="" class="xlarge" name="subscribe_link" id="subscribe_link" value="<?php echo $_smarty_tpl->tpl_vars['config']->value['SUBSCRIBE_LINK'];?>
">
		<span class="fi-help-text hide"></span>
	</div>
</div>

<?php echo upload_image_widget($_smarty_tpl->tpl_vars['subscribe_pic_data']->value);?>


<div class="formitems inline">
    <label class="fi-name">图文简述：</label>
    <div class="form-controls">
        <textarea name="subscribe_content" id="subscribe_content"><?php echo $_smarty_tpl->tpl_vars['config']->value['SUBSCRIBE_CONTENT'];?>
</textarea>
    </div>
</div>
