<?php /* Smarty version Smarty-3.1.6, created on 2017-07-31 13:03:08
         compiled from "C:\wamp\www\diandu\Tpl\AcpIndustry\add_industry.html" */ ?>
<?php /*%%SmartyHeaderCode:18377597eba0cd52e92-13977923%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'f8535cbb4b7f9abd1e9b77bca7e2443e7e33d634' => 
    array (
      0 => 'C:\\wamp\\www\\diandu\\Tpl\\AcpIndustry\\add_industry.html',
      1 => 1492679050,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '18377597eba0cd52e92-13977923',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_597eba0d26237',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_597eba0d26237')) {function content_597eba0d26237($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_truncate')) include 'C:\\wamp\\www\\diandu\\frame\\Extend\\Vendor\\Smarty\\plugins\\modifier.truncate.php';
?><!doctype html>
<html lang="en">
<head>
	<meta charset="UTF-8">
...
<div class="formitems inline">
    <label class="fi-name"><span class='colorRed'>*</span>行业名称：</label>
    <div class="form-controls">
		<input type="text" name='industry_name' id='title' placeholder="" class="small">
        <span class="fi-help-text"></span>
    </div>
</div>
<div class="formitems inline">
        <label class="fi-name"><span class='colorRed'>*</span>行业抽成比例：</label>
        <div class="form-controls">
            <input type="text" name='rate'  placeholder="" class="small">
            <span class="fi-help-text">如：1% 填写 0.01</span>
        </div>
</div>
<div class="formitems inline">
    <label class="fi-name">是否启用：</label>
    <div class="form-controls">
    <div class="radio-group">
    <label><input type="radio" name="isuse" class="j-skupanelCtrl" value="1" >是</label>
    <label><input type="radio" name="isuse" class="j-skupanelCtrl" value="0" >否</label>
    </div>
    </div>
</div>
<div class="formitems inline">
        ...
        <div class="form-controls">
            <input type="text" name='serial'  id='serial'  class="small">
            <span class="fi-help-text"></span>
        </div>
</div>
...
<div class="formitems inline">
    ...
    <div class="form-controls">
    	...
    	<button type="submit" class="btn btn-blue"><i class="gicon-ok white"></i>添加</button>
