<?php /* Smarty version Smarty-3.1.6, created on 2017-07-31 13:02:32
         compiled from "C:\wamp\www\diandu\Tpl\AcpStoreType\get_store_type_list.html" */ ?>
<?php /*%%SmartyHeaderCode:5053597eb9e80b3625-44309376%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '1f5aecf1a12f50d32425dea5c8265d201479e965' => 
    array (
      0 => 'C:\\wamp\\www\\diandu\\Tpl\\AcpStoreType\\get_store_type_list.html',
      1 => 1498539757,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '5053597eb9e80b3625-44309376',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_597eb9e8606ff',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_597eb9e8606ff')) {function content_597eb9e8606ff($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_truncate')) include 'C:\\wamp\\www\\diandu\\frame\\Extend\\Vendor\\Smarty\\plugins\\modifier.truncate.php';
?><!doctype html>
<html lang="en">
<head>
	<meta charset="UTF-8">
...
<div class="t-art" style="margin-bottom:10px;"><a href="/AcpStoreType/add_store_type" class="btn btn-blue"><i class="gicon-plus white"></i>添加店铺分类</a></div>
<div class="t-a-wait-con">
    <div class="tablesWrap"> 
    	<div class="tables-searchbox">
            <div class="t-a-wait-top">
                <form action="" method="post" id="rank_waiting">
                <div class="t-a-wait-top-li"><span>店铺类型名称：</span><input type="text" placeholder="" value="<?php echo $_smarty_tpl->tpl_vars['business_classify_name']->value;?>
" class="mini" name="business_classify_name"> </div>
...
?>
                <tr>  
                    ...
                    <td><?php echo $_smarty_tpl->tpl_vars['row']->value['business_classify_name'];?>
</td>
                    <td><img src="<?php echo $_smarty_tpl->tpl_vars['row']->value['img_url'];?>
" style="height:50px;"></td>
                    <td><?php if ($_smarty_tpl->tpl_vars['row']->value['isuse']==1){?>是<?php }else{ ?>否<?php }?></td>
                    <td><?php echo $_smarty_tpl->tpl_vars['row']->value['serial'];?>
</td>
                    <td>  
						<a href="/AcpStoreType/edit_store_type/business_classify_id/<?php echo $_smarty_tpl->tpl_vars['row']->value['business_classify_id'];?>
" class="btn" title="点击修改">修改</a>
						<?php if ($_smarty_tpl->tpl_vars['row']->value['business_classify_id']!=25){?>
                        <a href="javascript:;" class="btn" onclick="del_store_type(<?php echo $_smarty_tpl->tpl_vars['row']->value['business_classify_id'];?>
)">删除</a>
						<?php }?>
						<a href="/AcpStoreType/get_model_item/business_classify_id/<?php echo $_smarty_tpl->tpl_vars['row']->value['business_classify_id'];?>
" class="btn" >查看模板商品</a>
                    </td>  
                </tr>
                <?php }
...
function del_store_type(id)
{
	...
	{  
		 ...
		 {  
			 if(r)
			 {
				 $.post('/AcpStoreType/del_store_type', {"id":id}, function(data, textStatus)
				 {
					if (data == 'success')
					{
						alert('恭喜您，' + opt + '成功！');
