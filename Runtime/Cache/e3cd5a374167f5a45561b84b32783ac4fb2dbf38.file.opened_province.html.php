<?php /* Smarty version Smarty-3.1.6, created on 2017-07-24 14:16:47
         compiled from "C:\wamp\www\diandu\Tpl\AcpAgent\opened_province.html" */ ?>
<?php /*%%SmartyHeaderCode:28084597590cf74d741-59781064%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'e3cd5a374167f5a45561b84b32783ac4fb2dbf38' => 
    array (
      0 => 'C:\\wamp\\www\\diandu\\Tpl\\AcpAgent\\opened_province.html',
      1 => 1493260056,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '28084597590cf74d741-59781064',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_597590d115805',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_597590d115805')) {function content_597590d115805($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_truncate')) include 'C:\\wamp\\www\\diandu\\frame\\Extend\\Vendor\\Smarty\\plugins\\modifier.truncate.php';
...
?>
				<tr>
					<td><?php echo $_smarty_tpl->tpl_vars['province']->value['province_name'];?>
</td>
					<td><?php if ($_smarty_tpl->tpl_vars['province']->value['is_open']){?>是<?php }else{ ?>否<?php }?></td>
					<td><?php if ($_smarty_tpl->tpl_vars['province']->value['addtime']){?><?php echo smarty_modifier_date_format($_smarty_tpl->tpl_vars['province']->value['addtime'],"%Y-%m-%d %H:%M:%S");?>
<?php }else{ ?>--<?php }?></td>
					<td><?php if ($_smarty_tpl->tpl_vars['province']->value['realname']){?><?php echo $_smarty_tpl->tpl_vars['province']->value['realname'];?>
<?php }else{ ?>--<?php }?></td>
					<td><?php if ($_smarty_tpl->tpl_vars['province']->value['mobile']){?><?php echo $_smarty_tpl->tpl_vars['province']->value['mobile'];?>
<?php }else{ ?>--<?php }?></td>
					<td><?php if ($_smarty_tpl->tpl_vars['province']->value['username']){?><?php echo $_smarty_tpl->tpl_vars['province']->value['username'];?>
<?php }else{ ?>--<?php }?></td>
					<td><?php if ($_smarty_tpl->tpl_vars['province']->value['id']){?><?php echo $_smarty_tpl->tpl_vars['province']->value['id'];?>
<?php }else{ ?>--<?php }?></td>
					<td><?php if ($_smarty_tpl->tpl_vars['province']->value['bank_account']){?><?php echo $_smarty_tpl->tpl_vars['province']->value['bank_account'];?>
<?php }else{ ?>--<?php }?></td>
					<td><?php if ($_smarty_tpl->tpl_vars['province']->value['openning_bank']){?><?php echo $_smarty_tpl->tpl_vars['province']->value['openning_bank'];?>
<?php }else{ ?>--<?php }?></td>
					<!--<td><?php if ($_smarty_tpl->tpl_vars['province']->value['bank_mobile']){?><?php echo $_smarty_tpl->tpl_vars['province']->value['bank_mobile'];?>
<?php }else{ ?>&#45;&#45;<?php }?></td>-->
					<td>
						<?php if ($_smarty_tpl->tpl_vars['province']->value['is_open']){?>
						<a href="/AcpAgent/edit_agent/province_id/<?php echo $_smarty_tpl->tpl_vars['province']->value['province_id'];?>
" class="btn" title="修改账户信息">修改账户</a>
						<a href="javascript:;" class="btn" title="关闭" onclick="return closeCity(<?php echo $_smarty_tpl->tpl_vars['province']->value['province_id'];?>
);">关闭</a>
						<?php }else{ ?>
						<a href="/AcpAgent/add_agent/province_id/<?php echo $_smarty_tpl->tpl_vars['province']->value['province_id'];?>
" class="btn" title="开通">开通</a>
						<?php }?>
					</td>
				</tr>
			<?php }
if (!$_smarty_tpl->tpl_vars['province']->_loop) {
?>
