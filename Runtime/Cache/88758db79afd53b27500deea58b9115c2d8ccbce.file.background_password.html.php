<?php /* Smarty version Smarty-3.1.6, created on 2017-07-24 13:52:31
         compiled from "C:\wamp\www\diandu\Tpl\Index\background_password.html" */ ?>
<?php /*%%SmartyHeaderCode:2321559758b1f2b8de9-52825897%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '88758db79afd53b27500deea58b9115c2d8ccbce' => 
    array (
      0 => 'C:\\wamp\\www\\diandu\\Tpl\\Index\\background_password.html',
      1 => 1500865050,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '2321559758b1f2b8de9-52825897',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_59758b1f766e9',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_59758b1f766e9')) {function content_59758b1f766e9($_smarty_tpl) {?><?php if ($_smarty_tpl->tpl_vars['pc_site']->value==1){?>
<!doctype html>
...
<link rel="stylesheet" type="text/css" href="/Public/Css/front/front_css/background_password.css?version={$version}"/>
<style></style>
...
<div class="content">
    <p class="title">您的账号为：<?php echo $_smarty_tpl->tpl_vars['username']->value;?>
</p>
    <p class="shallow_blank">请输入您的登录密码</p>
    <p class="grey">店铺申请通过后，您将可以可以使用账户密码登录后台</p>
    <form action="" class="wrapper_box">
        <input type="password" placeholder="请输入密码" class="input_wrapper one" id="set_password">
        <a href="javascript:bind_mobile()" class="complete finish_btn">完成</a>
    </form>
</div>
...
<script type="text/javascript">
    function bind_mobile(){
        ...
        $.post("/FrontUserCenter/confirm_password",{
            "password":password
        },function(data){
            if(data=='success'){
                show_alert('密码验证成功');
                setTimeout(function(){
                    location.href='/Index/confirm_payment/';
                },1000);
            }else{
                show_alert('密码验证失败');
            }
