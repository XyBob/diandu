<?php /* Smarty version Smarty-3.1.6, created on 2017-07-31 17:39:08
         compiled from "C:\wamp\www\diandu\Tpl\AcpUser\user_detail.html" */ ?>
<?php /*%%SmartyHeaderCode:13406597efabc22d813-94106944%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '9720d1165f4d4364a90061e06ad4363fb7947ea5' => 
    array (
      0 => 'C:\\wamp\\www\\diandu\\Tpl\\AcpUser\\user_detail.html',
      1 => 1496228966,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '13406597efabc22d813-94106944',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_597efabc7e19e',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_597efabc7e19e')) {function content_597efabc7e19e($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_truncate')) include 'C:\\wamp\\www\\diandu\\frame\\Extend\\Vendor\\Smarty\\plugins\\modifier.truncate.php';
...
" style="width:50px;"></td> 
                ...
                <tr>  
                    <td class="tables-form-title">推广二维码：</td>  
					<td><img src="<?php echo $_smarty_tpl->tpl_vars['user_info']->value['qr_code'];?>
" style="width:50px;"></td> 
                </tr>
                <tr>  
                    <td class="tables-form-title">用户昵称：</td>
...
<?php }else{ ?>&#45;&#45;<?php }?></td>
                ...
                <tr>
					...
					<td><?php if ($_smarty_tpl->tpl_vars['user_info']->value['username']){?><?php echo $_smarty_tpl->tpl_vars['user_info']->value['mobile'];?>
<?php }else{ ?>--<?php }?></td>
                </tr>
                <!--<tr>
...
<?php }else{ ?>&#45;&#45;<?php }?></td>
                ...
                <tr>
                    <td class="tables-form-title">注册时间：</td>
...
<?php }else{ ?>&#45;&#45;<?php }?></td>
                ...
                <tr>  
                    ...
                    <td><?php if ($_smarty_tpl->tpl_vars['user_info']->value['role_type']==2){?>商家<?php }elseif($_smarty_tpl->tpl_vars['user_info']->value['role_type']==3){?>普通用户<?php }elseif($_smarty_tpl->tpl_vars['user_info']->value['role_type']==4){?>代理<?php }?></td>
                </tr>
                <tr>  
...
<?php }else{ ?>--<?php }?></td>
                ...
                <tr>  
					<td class="tables-form-title">钱包剩余：</td>
