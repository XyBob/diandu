<?php /* Smarty version Smarty-3.1.6, created on 2017-07-10 13:56:47
         compiled from "C:\wamp\www\diandu\Tpl\FrontMerchant\gathering_qr_code.html" */ ?>
<?php /*%%SmartyHeaderCode:140225963171f812132-99735730%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '95b8dd54a1833a9a8bcfbfa3df7d8dcd75699471' => 
    array (
      0 => 'C:\\wamp\\www\\diandu\\Tpl\\FrontMerchant\\gathering_qr_code.html',
      1 => 1493705739,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '140225963171f812132-99735730',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5963171fd3378',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5963171fd3378')) {function content_5963171fd3378($_smarty_tpl) {?><?php if ($_smarty_tpl->tpl_vars['pc_site']->value==1){?>
<!doctype html>
...
"/>
<style></style>
<script src="__JS__/front/jquery.qrcode.min.js?version=<?php echo $_smarty_tpl->tpl_vars['version']->value;?>
"></script>
...
?imageView2/1/w/100/h/100/q/100/" class="img-responsive">
    </div>
    <p class="name text-center"><?php echo $_smarty_tpl->tpl_vars['business_info']->value['business_name'];?>
</p>
    <div class="qr" id="qrcode">
        <img   src="http://qr.topscan.com/api.php?&bg=ffffff&fg=000000&text=http://<?php echo $_smarty_tpl->tpl_vars['url']->value;?>
/FrontMerchantOrder/buy_bill/business_id/<?php echo $_smarty_tpl->tpl_vars['business_info']->value['business_id'];?>
&logo=<?php echo $_smarty_tpl->tpl_vars['business_info']->value['sign_pic'];?>
?imageView2/1/w/100/h/100/q/100/" class="img-responsive">
    </div>
</div>
...
<script type="text/javascript">
    //$('#qrcode').qrcode("http://"+ '<?php echo $_smarty_tpl->tpl_vars['url']->value;?>
' +"/FrontMerchantOrder/buy_bill/business_id/<?php echo $_smarty_tpl->tpl_vars['business_info']->value['business_id'];?>
");
</script>
