<?php /* Smarty version Smarty-3.1.6, created on 2017-08-03 10:26:36
         compiled from "C:\wamp\www\diandu\Tpl\McpDeposit\get_deposit.html" */ ?>
<?php /*%%SmartyHeaderCode:12125959ce1d255605-85580701%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '1d00232b16db3d9b2f7f59bd0db11a529f53f234' => 
    array (
      0 => 'C:\\wamp\\www\\diandu\\Tpl\\McpDeposit\\get_deposit.html',
      1 => 1501727194,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '12125959ce1d255605-85580701',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.6',
  'unifunc' => 'content_5959ce1d6d4d3',
  'variables' => 
  array (
    'system_config' => 0,
    'version' => 0,
...
<?php if ($_valid && !is_callable('content_5959ce1d6d4d3')) {function content_5959ce1d6d4d3($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_truncate')) include 'C:\\wamp\\www\\diandu\\frame\\Extend\\Vendor\\Smarty\\plugins\\modifier.truncate.php';
?><!doctype html>
<html lang="en">
<head>
	<meta charset="UTF-8">
...
<form id="J_FormArticle" action="/McpDeposit/deposit_apply" method="post">
    <div class="formitems inline">
        <label class="fi-name"><span class="colorRed">*</span>当前店铺余额：</label>
        <div class="form-controls">
            <input type="text" placeholder="" class="xlarge" name="left_money" readonly value="<?php echo $_smarty_tpl->tpl_vars['left_money']->value;?>
">
            <span class="fi-help-text hide"></span>
        </div>
    </div>
<!--<div class="formitems inline">
    <label class="fi-name"><span class="colorRed">*</span>选择银行卡：</label>
    <div class="form-controls">
        <select name="bank_card_id">
			<?php  $_smarty_tpl->tpl_vars['bank_card'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['bank_card']->_loop = false;
 $_smarty_tpl->tpl_vars['key'] = new Smarty_Variable;
 $_from = $_smarty_tpl->tpl_vars['bank_card_list']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['bank_card']->key => $_smarty_tpl->tpl_vars['bank_card']->value){
$_smarty_tpl->tpl_vars['bank_card']->_loop = true;
 $_smarty_tpl->tpl_vars['key']->value = $_smarty_tpl->tpl_vars['bank_card']->key;
?>
				<option value="<?php echo $_smarty_tpl->tpl_vars['bank_card']->value['bank_card_id'];?>
"><?php echo $_smarty_tpl->tpl_vars['bank_card']->value['bank_name'];?>
</option>
			<?php } ?>
        </select>
		<span class="fi-help-text hide"></span>
...
<div class="formitems inline">
    <label class="fi-name"><span class="colorRed">*</span>提现金额：</label>
    <div class="form-controls">
        <input type="text" placeholder="" class="xlarge" name="amount">
		<span class="fi-help-text hide"></span>
    </div>
</div>
<div class="formitems inline">
    <label class="fi-name"><span class="colorRed">*</span>支付密码：</label>
    <div class="form-controls">
        <input type="password" placeholder="" class="xlarge" name="pay_password">
        <br>
		<span class="fi-help-text hide"></span>
        支付密码为登录密码,最低提现1元，最高50000,不满1000提现扣除0.5元提现手续费，满1000提现不收提现手续费
    </div>
</div>
<div class="formitems inline">
