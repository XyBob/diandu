...
return array(
    ...
    'APPSECRET' => 'c69f128a7481ffd09fd8becc8fa79f63', //微信APPSECRET
...
//'配置项'                 =>'配置值'
    'DB_HOST' => 'diandu.185.beyondin.com',
//'DB_NAME'               => 'diandu_online', //数据库名称
    'DB_NAME' => 'diandu', //数据库名称
    'DB_USER' => 'diandu', //数据库用户名
    'DB_PWD' => '&@!HRH(#!H(EHQ(w923', //数据库密码
    'DB_PORT' => '3306', //数据库端口
