...
class UserAddressModel extends Model
{
     ...
     * @todo 修改用户地址信息
     */
    public function editUserAddress($arr,$where)
    {
    ...
    public function getAddressDistanceSql($lon,$lat,$table_name,$temp_name,$user_id){
            $sql = '(SELECT *,ROUND('
                .'6378.138 * 2 * ASIN('
                .'SQRT('
                .    'POW('
    ...
    public function getAddressListByDistance($local_longitude,$local_latitude,$where='',$user_id){
        return $this->query('SELECT * from'.UserAddressModel::getAddressDistanceSql($local_longitude,$local_latitude,'tp_user_address','address',$user_id)
        );
    }
}
