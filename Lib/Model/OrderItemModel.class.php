...
class OrderItemModel extends Model
{
     ...
     * 往订单中添加商品
     * @author majian
     * @param array	$$item_list	商品信息数组，二维
     * @return 	void
     * @todo 将商品信息数组添加到商品订单表中
     */
    public function addItemList($item_list){
	...
	$user_rank['discount'] = $user_rank['discount'] ?$user_rank['discount']: 100;
    ...
    public function deleteItem($item_id)
    {
		...
		$this->where('order_id = ' . $this->orderId. ' and order_item_id ='.$item_id)->delete();
    }
	...
	public function getOrderItemNum($where){
