...
class UserSuggestModel extends Model
{
    ...
    public function getListData($user_suggest_list)
    {
		foreach ($user_suggest_list AS $k => $v)
		{
			...
			$user_info = $user_obj->getUserInfo('role_type, username,nickname');
...
//			}
			...
			$user_suggest_list[$k]['username'] = $user_info['username'];
            $user_suggest_list[$k]['nickname'] = $user_info['nickname'];
