 ...
 * acp后台商品分类
 */
class   McpClassAction extends McpAction
{
    ...
    public function _initialize()
    {
        ...
        $this->assign('action_src', U('/McpClass/list_class'));
        // 实例化模型类
        $this->Class     = D('Class');
    ...
    public function add_level_one()
    {
        ...
        if ($act == 'add') {
            ...
            if ($success) {
                $this->success('恭喜您，分类添加成功！', '/McpClass/add_level_one');
            } else {
                $this->error('抱歉，分类添加失败！', '/McpClass/add_level_one');
            }
        }
    ...
    {
        $redirect = U('/McpClass/get_level_one');
    ...
    {
        $redirect = U('/McpClass/get_level_two');
        ...
        if ($act == 'edit') {
            ...
            $url = '/McpClass/edit_level_two/sort_id/' . $sort_id;
