 ...
 * acp后台商品套餐类
 */
class McpItemPackageAction extends McpAction {
    ...
    public function add_item_package()
    {
        ...
        if($act == 'add')           //执行添加操作时
        {
            ...
            $redirect           = $redirect?url_jiemi($redirect):'/McpItemPackage/get_item_package_list/mod_id/2';
            ...
            if($item_package_id)
            {
                ...
                $this->success('恭喜你，套餐添加成功', '/McpItemPackage/get_item_package_list/mod_id/2');
            }
            else
            {
    ...
    {
        $redirect = U('/McpItemPackage/get_item_package_list/mod_id/2');
        ...
        if ($act == 'edit')
        {
            ...
            {
                $this->success('恭喜你，套餐修改成功', '/McpItemPackage/get_item_package_list/mod_id/2');
            }
            else
            {
